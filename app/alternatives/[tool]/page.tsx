  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
       ...
       <h2 className="text-2xl font-bold mb-6">{toolData.name} Alternatives <span className="text-base font-normal text-muted-foreground">({similar.length} tools listed)</span></h2>
...
<Link href={"/alternatives/" + t.id} className="text-xs text-muted-foreground hover:text-primary transition-colors">                    {t.name} Alternatives
                  </Link>
                </div>
              </div>
            </Link>
