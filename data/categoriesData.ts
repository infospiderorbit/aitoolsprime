...
// Pricing categories data
export const pricingCategoriesData = {
  "free-tools": {
    title: "Free AI Tools",
    description: "Completely free AI tools with no payment required",
    pricingType: "Free" as const
  },
  "freemium-tools": {
    title: "Freemium AI Tools", 
    description: "AI tools with free basic features and paid premium options",
    pricingType: "Freemium" as const
  },
  "paid-tools": {
    title: "Paid AI Tools",
    description: "Premium AI tools requiring payment for access",
    pricingType: "Paid" as const
  },
  "free-trial-tools": {
    title: "Free Trial AI Tools",
    description: "AI tools offering free trial periods before purchase",
    pricingType: "Free Trial" as const
  }
};