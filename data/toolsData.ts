...
export const toolsData: { [key: string]: { [key: string]: Tool[] } } = {
  ...
  "chatbots-virtual-companions": {
    ...
    "ai-girlfriend": [
      ...
      { id: "pephop-ai2", addedDate: "2026-03-31", name: "PepHop AI", description: "AI character chat platform with thousands of anime fictional and custom AI companions", url: "https://pephop.ai", upvotes: 2250, verified: false, rating: 4.4, icon: "🎭", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
