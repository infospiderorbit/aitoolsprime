...
export const toolsData: { [key: string]: { [key: string]: Tool[] } } = {
  ...
  "image-generation-editing": {
    ...
    "ai-face-swap-generator": [
      { id: "kirkify", name: "Kirkify AI Images Generator", description: "AI face swap meme generator for creating viral Kirkified images instantly", url: "https://kirkify.io", upvotes: 876, verified: true, rating: 4.3, icon: "🔄", category: "image-generation-editing", subcategory: "ai-face-swap-generator" },
