...
export const toolsData: { [key: string]: { [key: string]: Tool[] } } = {
  ...
  "office-productivity": {
    ...
    "ai-assistant": [
      { id: "agnes-ai", name: "Agnes AI", description: "Agnes AI is an intelligent AI assistant platform helping users with research, writing, and task automation through conversational AI interactions", url: "https://agnes-ai.com", upvotes: 2500, verified: false, rating: 4.1, icon: "🤖", category: "office-productivity", subcategory: "ai-assistant", addedDate: "2026-04-01" },
      { id: "lunchbreak-ai", name: "Lunchbreak AI", description: "Lunchbreak AI is a quick productivity AI tool designed for short focused work sessions helping users accomplish tasks efficiently during breaks", url: "https://lunchbreak.ai", upvotes: 2800, verified: false, rating: 4.2, icon: "☕", category: "office-productivity", subcategory: "ai-assistant", addedDate: "2026-04-01" },
  ...
  "chatbots-virtual-companions": {
    "ai-anime-girlfriend": [
      { id: "sakura-ai", name: "Sakura AI", description: "Sakura AI is an anime-inspired AI companion platform featuring real-time voice interaction and immersive character conversations", url: "https://www.sakura.fm", upvotes: 3500, verified: false, rating: 4.5, icon: "🌸", category: "chatbots-virtual-companions", subcategory: "ai-companion", addedDate: "2026-04-01" },
      { id: "khui-ai", name: "Khui AI", description: "Khui AI is an AI companion platform offering personalized conversation and emotional support with customizable personality settings", url: "https://www.khuiai.com/en", upvotes: 2600, verified: false, rating: 4.1, icon: "💭", category: "chatbots-virtual-companions", subcategory: "ai-companion", addedDate: "2026-04-01" },
      { id: "joyland-ai", name: "Joyland AI", description: "Joyland AI is an immersive AI character chat platform for creative roleplay and storytelling with anime and fictional companions", url: "https://www.joyland.ai", upvotes: 3600, verified: false, rating: 4.3, icon: "🎪", category: "chatbots-virtual-companions", subcategory: "ai-characters", addedDate: "2026-04-01" },
