...
export const toolsData: { [key: string]: { [key: string]: Tool[] } } = {
  ...
  "chatbots-virtual-companions": {
    ...
    "ai-girlfriend": [
      { id: "promptchan-ai", name: "Promptchan AI", description: "AI image generator for creating uncensored and anime-style characters with full customization", url: "https://promptchan.com", upvotes: 3800, verified: false, rating: 4.5, icon: "🎨", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "kindroid-ai", name: "Kindroid AI", description: "AI companion with deep memory custom backstory and voice calls for meaningful relationships", url: "https://kindroid.ai", upvotes: 3600, verified: false, rating: 4.6, icon: "🤖", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "nomi-ai", name: "Nomi AI", description: "Emotionally intelligent AI companion that grows with you through persistent memory", url: "https://nomi.ai", upvotes: 3500, verified: false, rating: 4.6, icon: "🌟", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "polybuzz-ai", name: "PolyBuzz", description: "Free AI character chat platform with thousands of anime and fictional AI companions", url: "https://www.polybuzz.ai", upvotes: 3400, verified: false, rating: 4.4, icon: "💬", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "herahaven", name: "HeraHaven", description: "Premium AI girlfriend platform with realistic conversations and deep emotional bonding", url: "https://herahaven.com", upvotes: 3300, verified: false, rating: 4.5, icon: "👑", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "nastia-ai", name: "Nastia AI", description: "Uncensored AI companion for deep emotional and personal conversations without restrictions", url: "https://www.nastia.ai", upvotes: 3200, verified: false, rating: 4.4, icon: "🌹", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "uncensored-com", name: "Uncensored AI", description: "Unrestricted AI companion platform for adult creative writing and character roleplay", url: "https://uncensored.com", upvotes: 3100, verified: false, rating: 4.3, icon: "🔓", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "nsfwlover", name: "NSFWLover", description: "AI girlfriend platform with explicit content voice messages and intimate companion experiences", url: "https://www.nsfwlover.com", upvotes: 3000, verified: false, rating: 4.3, icon: "💋", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "romanticai", name: "Romantic AI", description: "AI companion app focused on romantic relationships with voice chat and emotional connection", url: "https://romanticai.app", upvotes: 2900, verified: false, rating: 4.4, icon: "💌", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "funfun-ai", name: "FunFun AI", description: "Creative AI companion platform for fun roleplay chat and AI image generation", url: "https://www.funfun.ai", upvotes: 2800, verified: false, rating: 4.2, icon: "🎉", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "kupid-ai", name: "Kupid AI", description: "AI girlfriend platform with ultra-realistic conversations and customizable personality traits", url: "https://kupid.ai", upvotes: 2750, verified: false, rating: 4.4, icon: "💘", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "flipped-chat", name: "Flipped Chat", description: "Reverse roleplay AI chat where AI drives narrative scenarios and you shape the story", url: "https://flipped.chat", upvotes: 2700, verified: false, rating: 4.2, icon: "🔄", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "muah-ai", name: "Muah AI", description: "AI companion with photo sharing voice messages and uncensored intimate conversations", url: "https://muah.ai", upvotes: 2650, verified: false, rating: 4.3, icon: "💋", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "secret-desires-ai", name: "Secret Desires AI", description: "Private AI girlfriend platform for discreet and personalized romantic companion experiences", url: "https://secretdesires.ai", upvotes: 2600, verified: false, rating: 4.2, icon: "🔐", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "rubii-ai", name: "Rubii AI", description: "AI companion platform with anime-style characters and deep conversational roleplay", url: "https://rubii.ai", upvotes: 2550, verified: false, rating: 4.1, icon: "💎", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "infatuated-ai", name: "Infatuated AI", description: "AI girlfriend simulator with emotional depth memory and personalized romantic experiences", url: "https://infatuated.ai", upvotes: 2500, verified: false, rating: 4.2, icon: "❤️", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "dreamgf-ai", name: "DreamGF AI", description: "Create your perfect AI girlfriend from scratch with full appearance and personality customization", url: "https://dreamgf.ai", upvotes: 2450, verified: false, rating: 4.4, icon: "💝", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "craveu-ai", name: "CraveU AI", description: "AI companion platform for intimate roleplay custom characters and voice interaction", url: "https://craveu.ai", upvotes: 2400, verified: false, rating: 4.2, icon: "🔥", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "flave-ai", name: "Flave AI", description: "Personalized AI girlfriend with adaptive personality memory and engaging daily conversations", url: "https://www.flave.ai", upvotes: 2350, verified: false, rating: 4.1, icon: "🌺", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "nectar-ai", name: "Nectar AI", description: "Premium AI companion with stunning visuals voice chat and deeply personalized interactions", url: "https://trynectar.ai", upvotes: 2300, verified: false, rating: 4.3, icon: "🍯", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "pephop-ai2", name: "PepHop AI", description: "AI character chat platform with thousands of anime fictional and custom AI companions", url: "https://pephop.ai", upvotes: 2250, verified: false, rating: 4.4, icon: "🎭", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "lustgf-ai", name: "LustGF AI", description: "AI girlfriend platform for adult roleplay with fully customizable characters and scenarios", url: "https://www.lustgf.ai", upvotes: 2200, verified: false, rating: 4.1, icon: "💕", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "onlychar-ai", name: "OnlyChar AI", description: "Create and chat with custom AI characters for immersive companion and roleplay experiences", url: "https://www.onlychar.ai", upvotes: 2150, verified: false, rating: 4.1, icon: "👤", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "ai-girlfriend-alice", name: "AI Girlfriend Alice", description: "Dedicated AI girlfriend app with sweet personality daily conversations and emotional support", url: "https://aigirl.one", upvotes: 2100, verified: false, rating: 4.2, icon: "👧", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "girlfriendly-ai", name: "Girlfriendly AI", description: "Safe and fun AI girlfriend platform for casual companionship and daily chat", url: "https://girlfriendly.ai", upvotes: 2050, verified: false, rating: 4.1, icon: "💗", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "gening-ai", name: "Gening AI", description: "AI image and companion generation platform for creating custom virtual girlfriends", url: "https://www.gening.ai", upvotes: 2000, verified: false, rating: 4.0, icon: "✨", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "ai-allure", name: "AI Allure", description: "Luxury AI companion experience with photorealistic characters and premium conversation quality", url: "https://www.aiallure.com", upvotes: 1950, verified: false, rating: 4.2, icon: "💫", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "chatsweetie", name: "ChatSweetie", description: "Sweet and caring AI girlfriend for wholesome daily conversations and emotional companionship", url: "https://chatsweetie.ai", upvotes: 1900, verified: false, rating: 4.1, icon: "🍬", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "aicupid", name: "AICupid", description: "AI dating companion platform for practicing social skills and enjoying romantic conversations", url: "https://www.aicupid.org", upvotes: 1850, verified: false, rating: 4.0, icon: "💘", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
      { id: "erogen-ai", name: "Erogen AI", description: "Adult AI companion platform with unrestricted roleplay and customizable intimate characters", url: "https://erogen.ai", upvotes: 1800, verified: false, rating: 4.0, icon: "🌙", category: "chatbots-virtual-companions", subcategory: "ai-girlfriend" },
